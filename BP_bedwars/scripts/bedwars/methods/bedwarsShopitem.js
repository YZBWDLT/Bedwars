...
/**
 * @typedef { "blocks_and_items" | "weapon_and_armor" | "team_upgrade" | "weapon_and_armor_capture" } traderType 可用商人类型列表
 */
 ...
 * @property {shopitemType} itemType 商店物品类型
...
export class Shopitem{
    ...
    /**
     * @param {traderType} traderType 对应的商人类型
     * @param {String} id 物品 ID（自动生成商店物品 ID 为 bedwars:shopitem_(id) ）
     * @param {Number} slot 物品所处槽位
     ...
     */
    constructor( id, slot, traderType, costResourceType, costResourceAmount, itemAmount, options = {} ) {
...
export const shopitems = {
    /** 方块与物品 */
    blocksAndItems: [
        new Shopitem( "wool", 0, "blocks_and_items", "iron", 4, 16, { itemType: "coloredBlock", description: "可用于搭桥穿越岛屿。搭出的桥的颜色会对应你的队伍颜色。" } ),
        new Shopitem( "stained_hardened_clay", 1, "blocks_and_items", "iron", 12, 16, { itemType: "coloredBlock", description: "用于保卫床的基础方块。" } ),
        new Shopitem( "blast_proof_glass", 2, "blocks_and_items", "iron", 12, 4, { itemType: "coloredBlock", description: "免疫爆炸。" } ),
        new Shopitem( "end_stone", 3, "blocks_and_items", "iron", 24, 12, { description: "用于保卫床的坚固方块。" } ),
        new Shopitem( "planks", 4, "blocks_and_items", "gold", 4, 16, { description: "为床提供保护的不错块选。\n 面对镐子的攻势也很强势。", itemId: "bedwars:oak_planks" } ),
        new Shopitem( "ladder", 5, "blocks_and_items", "gold", 4, 8, { description: "可用于救助困在树上的猫猫。", itemId: "minecraft:ladder" } ),
        new Shopitem( "obsidian", 6, "blocks_and_items", "emerald", 4, 4, { description: "为你的床提供超级保护。" } ),
    
        new Shopitem( "potion_speed", 7, "blocks_and_items", "emerald", 1, 1, { description: "§9速度 II (0:30)", itemType: "potion" } ),
        new Shopitem( "potion_jump_boost", 8, "blocks_and_items", "emerald", 1, 1, { description: "§9跳跃提升 V (0:45)", itemType: "potion" } ),
        new Shopitem( "potion_invisibility", 9, "blocks_and_items", "emerald", 2, 1, { description: "§9完全隐身 (0:30)", itemType: "potion" } ),
    
        new Shopitem( "golden_apple", 10, "blocks_and_items", "gold", 3, 1, { description: "疗伤好物。", itemId: "minecraft:golden_apple" } ),
        new Shopitem( "bed_bug", 11, "blocks_and_items", "iron", 24, 1, { description: "在雪球砸中的地方产生一只持续\n 15 秒的蠹虫，为你吸引火力。" } ),
        new Shopitem( "dream_defender", 12, "blocks_and_items", "iron", 120, 1, { description: "让铁傀儡成为你的守家好帮手。\n 持续 4 分钟。" } ),
        new Shopitem( "fireball", 13, "blocks_and_items", "iron", 40 , 1, { description: "右键发射！击飞在桥上行走的敌人！" } ),
        new Shopitem( "tnt", 14, "blocks_and_items", "gold", 8, 1, { description: "放下后即点燃。要炸毁什么\n 东西，它很在行！", costResourceAmountInSolo: 4 } ),
        new Shopitem( "ender_pearl", 15, "blocks_and_items", "emerald", 4, 1, { description: "快速打入敌人内部。", itemId: "minecraft:ender_pearl" } ),
        new Shopitem( "water_bucket", 16, "blocks_and_items", "gold", 3, 1, { description: "使来犯敌人减速的良好选择。\n 也能应对 TNT 的威胁。", itemId: "minecraft:water_bucket", costResourceAmountInSolo: 2 } ),
        new Shopitem( "bridge_egg", 17, "blocks_and_items", "emerald", 1, 1, { description: "能够沿着其扔出的轨迹\n 创造一座桥梁。" } ),
        new Shopitem( "magic_milk", 18, "blocks_and_items", "gold", 4, 1, { description: "饮用后能够在 30 秒内\n 防止触发敌人的陷阱。" } ),
        new Shopitem( "sponge", 19, "blocks_and_items", "gold", 3, 4, { description: "吸水好手。", itemId: "minecraft:sponge", costResourceAmountInSolo: 2 } )    
    ],
    /** 武器与盔甲 */
    weaponAndArmor: [
        new Shopitem( "stone_sword", 0, "weapon_and_armor", "iron", 10, 1, { itemType: "sword" } ),
        new Shopitem( "iron_sword", 1, "weapon_and_armor", "gold", 7, 1, { itemType: "sword" } ),
        new Shopitem( "diamond_sword", 2, "weapon_and_armor", "emerald", 3, 1, { itemType: "sword", costResourceAmountInSolo: 4 } ),
        new Shopitem( "knockback_stick", 3, "weapon_and_armor", "gold", 5, 1, { itemType: "knockbackStick" } ),
        
        new Shopitem( "chain_armor", 4, "weapon_and_armor", "iron", 24, 1, { description: "获得永久的锁链护腿靴子。", itemType: "armor" } ),
        new Shopitem( "iron_armor", 5, "weapon_and_armor", "gold", 12, 1, { description: "获得永久的铁护腿靴子。", itemType: "armor" } ),
        new Shopitem( "diamond_armor", 6, "weapon_and_armor", "emerald", 6, 1, { description: "钻石护腿和靴子将一直伴你左右。", itemType: "armor" } ),
        new Shopitem( "shears", 7, "weapon_and_armor", "iron", 20, 1, { description: "破坏羊毛的得力工具。\n 该物品是永久的。", itemType: "shears" } ),
        new Shopitem( "wooden_axe", 8, "weapon_and_armor", "iron", 10, 1, { tier: 1, isHighestTier: false, loseTierUponDeath: true, itemType: "axe" } ),
        new Shopitem( "stone_axe", 9, "weapon_and_armor", "iron", 10, 1, { tier: 2, isHighestTier: false, loseTierUponDeath: true, itemType: "axe" } ),
        new Shopitem( "iron_axe", 10, "weapon_and_armor", "gold", 3, 1, { tier: 3, isHighestTier: false, loseTierUponDeath: true, itemType: "axe" } ),
        new Shopitem( "diamond_axe", 11, "weapon_and_armor", "gold", 6, 1, { tier: 4, isHighestTier: true, loseTierUponDeath: true, itemType: "axe" } ),
        new Shopitem( "wooden_pickaxe", 12, "weapon_and_armor", "iron", 10, 1, { tier: 1, isHighestTier: false, loseTierUponDeath: true, itemType: "pickaxe" } ),
        new Shopitem( "iron_pickaxe", 13, "weapon_and_armor", "iron", 10, 1, { tier: 2, isHighestTier: false, loseTierUponDeath: true, itemType: "pickaxe" } ),
        new Shopitem( "golden_pickaxe", 14, "weapon_and_armor", "gold", 3, 1, { tier: 3, isHighestTier: false, loseTierUponDeath: true, itemType: "pickaxe" } ),
        new Shopitem( "diamond_pickaxe", 15, "weapon_and_armor", "gold", 6, 1, { tier: 4, isHighestTier: true, loseTierUponDeath: true, itemType: "pickaxe" } ),
    ...
    /** 队伍升级 */
    teamUpgrade: [
        new Shopitem( "sharpened_swords", 0, "team_upgrade", "diamond", 8, 1, { description: "己方所有成员的剑和斧\n 将永久获得锋利 I 的效果！", itemType: "teamUpgrade", costResourceAmountInSolo: 4 } ),
    ...
    get weaponAndArmorCapture() {
        return [
            ...this.weaponAndArmor,
            new Shopitem( "bed", 20, "weapon_and_armor_capture", "diamond", 2, 1, { description: "在基岩上放床以夺取点位。", itemType: "coloredBlock" } )    
        ]
    }
}
