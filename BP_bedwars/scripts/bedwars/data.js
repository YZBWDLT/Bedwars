...
export const updateLog = {
    ...
    version1_1: [
        ...
        "§l新地图",
        "§7- §l§b重要更新§r§7 新增1张4队地图：伊斯特伍德（Eastwood）和3张8队地图：瀑布（Waterfall）、乐园（Playground）、灯塔（Lighthouse）。",
    ...
    versionTest: [
        ...
        "§l经验模式",
        "§7- §l§b重要更新§r§7 隆重推出——经验模式！",
        "§7- 在设置中，合并了资源上限设置和资源间隔设置为「资源设置」",
        "§7- 玩家获取的铁锭、金锭、绿宝石会转化为经验",
        "§7  - 默认情况下，1 铁锭会转化为 1 等级，1 金锭会转化为 10 等级，而 1 绿宝石会转化为 100 等级",
        "§7  - 钻石不会转化为经验",
        "§7  - 在新的「资源设置」中新增了铁锭价值、金锭价值、绿宝石价值三个选项，以调整在经验模式中一个资源所价值的等级",
        "§7- 在经验模式下，物品商店接收经验，而非铁锭、金锭和绿宝石",
        "§7  - 物品的售价是随着铁锭价格、金锭价格、绿宝石价格而等比例放大的",
        "§7  - 默认情况下，在经典模式卖 1 个铁锭的物品，现在需要 1 等级购买，卖 1 个金锭的物品需要 10 等级购买，卖 1 个绿宝石的物品需要 200 等级购买",
        "§7  - 例如，在经典模式卖 6 个绿宝石的钻石套，现在需要 1200 经验购买",
        "§7  - 部分物品可能拥有自己独特的售价",
        "§7  - 在「资源设置」中新增了铁锭价格、金锭价格、绿宝石价格三个选项，以调整在经典模式中的售价如何等比例地增长",
        "§7- 在商店新增了可共享的铁锭、金锭和绿宝石，扔出这些物品再拾起即可获取对应的经验值，在商店中的价格随着这三样物品的价值的变动而变动",
        "§7- 团队升级商人没有变化，依旧接收钻石",
        "§7- 调整了经验模式的资源生成速率",
        "§7  - 默认情况下，队伍岛的资源生成速率放缓到经典模式的 0.5 倍，而中岛的资源生成速率加快到经典模式的 1.5 倍，这样，中岛的资源生成效率要快于队伍岛",
        "§7  - 钻石的生成速率没有变化",
        "§7  - 在「资源设置」新增了经验模式生成队伍岛资源速度倍率和经验模式生成绿宝石速度倍率两个设置，用于调整资源生成速率",
        "§7- 在「资源设置」新增了经验模式损失资源的设置，决定在玩家死亡后将损失多少经验，并给予击杀者，可选项有全部损失、损失一半和不损失",
        "§7- 在设置中，新增了启用二队、四队、八队经验模式的开关，并允许单独生成对应的经验模式",
        "§7- 在「资源设置」中新增了队伍资源生成点共享资源的设置，以允许玩家在队伍资源生成点获取资源时可以不用抢夺，而是所有人均可共享，默认为开启，但目前还没有实装功能",
        "§l商人交易",
        "§7- 现在不再允许两个玩家同时打开一个商人的 UI，如果检查到此情况会立刻关闭这两名玩家的 UI",
        "§l自主选队",
        "§7- §l§b重要更新§r§7 #48 重新设计了自主选队的机制，现在在游戏前基于一个 NPC 进行自主选队",
        "§7- 这样做，可以保证自主选队的 UI 及时更新",
        "§7- 并且也补全了有关玩家退出时的检查机制",
        "§l设置",
        "§7- #59 在杂项设置中新增了恢复饥饿值间隔设置，默认为 3 秒恢复一次（上个版本是 10 秒恢复一次）",
        "§l漏洞修复",
        "§7- #49 修复了在游玩过程中可能会出现的一些日志报错",
        "§7- #50 修复了商店可以扔出标签页物品的问题",
        "§7- #51 修复了无床队伍的最后一名玩家退出后不会触发队伍淘汰的问题",
        "§7- #52 修复了在有玩家购买魔法牛奶后，会导致所有食物均附加魔法牛奶效果的问题",
        "§7- #53 修复了含水床无法检查的问题",
        "§7- #57 现在在地图兰花中，绿队的队旗可以成功替换了",
        "§7- 修复了在生成地图阶段尝试生成其他地图会导致地图强制生成并后续流程锁死的问题",
        "§7- 修复了已被淘汰的队伍在因为某些原因被二次淘汰后，会导致其他存活队伍被淘汰的问题",
        "§7- 修复了玩家在点击床设置重生点后，再死亡会在床的位置重生而非在地图正上方重生的问题",
        "§7- 调整了地图瀑布的出生点，以解决全部队伍都无法围床 3 层的问题",
        "§7- 调整了地图瀑布的地图下限并更改了超界算法，以解决搭桥蛋和末影珍珠提前清除的问题",
    ],
}
