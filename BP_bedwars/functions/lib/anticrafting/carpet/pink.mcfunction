...
give @s[hasitem={item=carpet,quantity=192..}] wool 128 6
clear @s[hasitem={item=carpet,quantity=192..}] carpet -1 192

give @s[hasitem={item=carpet,quantity=96..}] wool 64 6
clear @s[hasitem={item=carpet,quantity=96..}] carpet -1 96

give @s[hasitem={item=carpet,quantity=48..}] wool 32 6
clear @s[hasitem={item=carpet,quantity=48..}] carpet -1 48

give @s[hasitem={item=carpet,quantity=24..}] wool 16 6
clear @s[hasitem={item=carpet,quantity=24..}] carpet -1 24

give @s[hasitem={item=carpet,quantity=12..}] wool 8 6
clear @s[hasitem={item=carpet,quantity=12..}] carpet -1 12

give @s[hasitem={item=carpet,quantity=6..}] wool 4 6
clear @s[hasitem={item=carpet,quantity=6..}] carpet -1 6

give @s[hasitem={item=carpet,quantity=3..}] wool 2 6
