...
export const updateLog = {
    ...
    version1_1: [
        ...
        "§7- §l§b重要更新§r§7 新增主动旁观模式！可以在「设置 - 旁观模式设置」中启用，以允许主动旁观",
        "§7- §l§b重要更新§r§7 现在旁观者可以抬头以打开传送 UI！可以在「设置 - 旁观模式设置」中启用，以允许旁观传送",
        "§7- 修复了无法破坏蕨的问题",
        "§7- 修复了床自毁会提示所有玩家的问题，现在不再对旁观玩家提示床自毁",
        "§l资源生成",
    ...
    versionTest: [
        ...
        "§l旁观模式",
        "§7- §l§b重要更新§r§7 #7 新增主动旁观模式！",
        "§7  - 可以在「设置 - 旁观模式设置」中启用，以允许主动旁观",
        "§7  - 在开启了旁观模式的情况下，玩家可以使用一个新物品以打开主动旁观的设置 UI，在此 UI 中玩家可以选择不旁观、仅下局旁观、或之后的所有游戏都旁观",
        "§7  - 选择了*仅下局旁观*或*之后的所有游戏都旁观*的玩家，会在开始游戏后自动归为旁观模式",
        "§7  - 开启主动旁观后不能选队，已选队伍的信息会消失",
        "§7  - 如果在开启了主动旁观的情况下，房主禁用了主动旁观功能，则会警告已开启了主动旁观的玩家，之后的游戏需注意参与",
        "§7- §l§b重要更新§r§7 #46 现在旁观者可以抬头以打开传送 UI！",
        "§7  - 可以在「设置 - 旁观模式设置」中启用，以允许旁观传送",
        "§7  - 便于玩家观察某个玩家的行动",
        "§l漏洞修复",
        "§7- #80 修复了无法破坏蕨的问题",
        "§7- #84 修复了每当玩家变化且人数不足时就会警告人数不足的问题",
        "§7- #85 修复了使用铁傀儡右键箱子会放置铁傀儡的问题",
        "§7- #86 修复了床自毁会提示所有玩家的问题，现在不再对旁观玩家提示床自毁",
        "§7- #87 修复了在手机端可以先将商店物品放到空栏位再直接拿出的问题",
        "§7- 修复了在地图屋顶中可以冲毁铁轨和花盆的问题",
        "§7- 修复了在地图乐园中可以冲毁地毯的问题",
    ],
}
