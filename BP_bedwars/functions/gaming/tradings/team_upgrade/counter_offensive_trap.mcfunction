...
## 当该玩家物资充足时
execute if entity @s[scores={temp=0},hasitem={item=bedwars:diamond,quantity=1..}] run function gaming/tradings/team_upgrade/counter_offensive_trap_2
execute if entity @s[scores={temp=1..,temp2=0},hasitem={item=bedwars:diamond,quantity=2..}] run function gaming/tradings/team_upgrade/counter_offensive_trap_3
execute if entity @s[scores={temp=1..,temp2=1..,temp3=0},hasitem={item=bedwars:diamond,quantity=4..}] run function gaming/tradings/team_upgrade/counter_offensive_trap_4

# --- 清除标记物品 ---
clear @s bedwars:upgrade_counter_offensive_trap